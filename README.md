...
- 📦 **2,086+ dataset downloads** — BanglaVegNet on Mendeley Data
...
- E2E, visual, and API test coverage across a full web application
- GitHub Actions pipeline for continuous regression testing on every PR
- Structured test case design following SDLC/STLC best practices

`Playwright` `REST API` `GitHub Actions` `Node.js` `CI/CD`

🔗 [View Repository](https://github.com/sumona18/qa-automation-framework)

---

## Publications

### Elsevier Q1 · Healthcare Analytics · 2025 ✅ Published
...
4,730 images · 42 vegetable classes · 2,086+ downloads on Mendeley Data
...
**Languages & Frameworks** — `Python` `JavaScript` `Node.js` `SQL`

**AI / ML / CV** — `PyTorch` `TensorFlow` `scikit-learn` `OpenCV` `NumPy` `Pandas`

**QA & Automation** — `Playwright` `REST API Testing` `GitHub Actions` `CI/CD` `Jira`

**Data & Databases** — `MySQL` `MongoDB` `LaTeX`
...
- 🎓 **North South University** — MSc in Computer Science & Engineering · CGPA 3.50/4.00 · 2025–Present
- 🎓 **Bangladesh University of Business & Technology** — BSc in CSE (AI Major) · CGPA 3.82/4.00 · 3rd in Department · 2021–2025
- 📘 **Shaheed Police Smrity College** — HSC · GPA 5.00/5.00 · 2020
